...
#define UE_PROJECT_NAME GrootLabirint
#define UE_TARGET_NAME GrootLabirintEditor
#define UE_MODULE_NAME "GrootLabirint"
...
#define GROOTLABIRINT_API DLLEXPORT
